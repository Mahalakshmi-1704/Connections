...
function buildArray(data) {
  return data.flatMap(group => group.members.map(member => 
                            ({id: group.title + ":" + member, value: member, category: group.title, color: group.color})));
}
...
export default function App() {
  ...
  function handleRestart() {
    loadData();
    const newGroups = constructGroup(categories, order);
    setGroups(newGroups);
...
*/
  ...
  return (
    <div className="game-container">
        ...
        <select name="order" id="order" value={order} onChange={handleOrderChange}>
